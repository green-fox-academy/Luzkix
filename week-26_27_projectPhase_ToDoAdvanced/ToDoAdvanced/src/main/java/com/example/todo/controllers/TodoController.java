...
public class TodoController {
  ...
  @PostMapping("/newTodo")
  ResponseEntity<?> createNewTodo(@RequestBody Todo input) {
    try {
  ...
  ResponseEntity<?> updateTodo(@RequestBody UpdateTodoDTO updatedTodoData) {
    try {
      Todo updatedTodo = todoService.updateTodo(updatedTodoData);
